...
/**
 * This class automatically populates our database by cycling through the
 * new images we wish to add. The only drawback to this method is that the
 * images must be properly named and match a row in the database. * 
 * 
 * @author Rob Wagner

 ...
 * 
 * [0, i] and [0, j] are the same range and represent the possible states to
 * transition between.
 * 
 * @author Alex Petitjean, Rob Wagner Created Apr 18, 2012. Last Updated Apr 26,
 *         2012.
 */
public class TransitionMatrix implements Serializable {
	 ...
	 *             if t1 and t2 have different sizes
	 */
	public static TransitionMatrix average2Matrices(TransitionMatrix t1,
			TransitionMatrix t2) throws IllegalArgumentException {
		if (t1.size != t2.size)
